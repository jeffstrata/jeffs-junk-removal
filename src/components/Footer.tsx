...
export default function Footer() {
  ...
  return (
    <footer className="bg-navy-dark text-gray-300 relative overflow-hidden">
      {/* Subtle top border */}
      <div className="h-1 bg-gradient-to-r from-transparent via-accent to-transparent" />

      <div className="container-narrow mx-auto py-16 md:py-20 px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <img
              ...
              className="h-16 w-auto mb-3 drop-shadow-[0_0_6px_rgba(255,255,255,0.8)]"
            />
            ...
            <div className="space-y-3">
              <a
                href={`tel:${PHONE}`}
                className="flex items-center gap-2 text-accent hover:text-accent-light font-bold text-lg transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/free-quote/" className="text-gray-400 hover:text-accent transition-colors">Get a Free Quote</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-2 text-sm">
              {serviceAreas.map((area) => (
                <li key={area} className="flex items-center gap-1.5 text-gray-400">
